...
graduates.forEach(function(items){
  console.log(`${items.first_name} ${items.email}`);
});

// console.log(contactInfo);
/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
let unisWithUni = [];
unisWithUni = graduates.filter(newUni);
function newUni(graduate){
  return graduate.university.indexOf('Uni') !== -1;
}
...
lowPopulationAnimals = zooAnimals.filter(function(item){
...
*/
let populationTotal = 
zooAnimals.reduce(function(item, zooAnimals, population){
  return zooAnimals.population + population;
}, 0);
