...
*/
const displayNames = zooAnimals.forEach((item) => {
...
zooAnimals.map((item) => `${item.animal_name}`.toLowerCase());
...
zooAnimals.filter((item) => item.population < '5');
...
*/
let populationTotal = 
zooAnimals.reduce((item, zooAnimals, population) => {
